...
class Scan_msg:
	...
	self.sect_2 = 0
	self.sect_3 = 0
	self.ang = {0:0, 001:-2, 10:-2, 11:-2, 100:2, 101:2,110:2,111:2}
	self.fwd = {0:.5, 1:0,10:0, 11:0,100:0.1,101:0,110:0,111:0}
	...
	z = ((14 * self.msg.angular.z) + self.ang[sect]) / 15
	x = ((9 * self.msg.linear.x) + self.fwd[sect]) / 10
