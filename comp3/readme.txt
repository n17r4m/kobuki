...
2. Using our own map, 'roslaunch turtlebot_navigation amcl_demo.launch map_file:=./comp3/maps/robot9000_CSC2ndFlr_map.yaml'
3. To visualize, 'roslaunch turtlebot_rviz_launchers view_navigation.launch'
4. To do circle run, 'rosrun comp3 navi.py' or './navi.py'
